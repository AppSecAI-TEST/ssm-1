...
<%@ include file="header.jsp" %>
	<div class="container">
		<form class="form-horizontal" action="/updateStudentById" method="post">
		...
		<div class="col-sm-4">
			<input class="form-control" type="text" pattern="\d+" maxlength=3  name="id" placeholder="请输入要修改的学生编号" required >
		</div>
		</div>
		<div class="form-group">
