...
<div class="container">
    <form class="well form-horizontal" action="/signin" method="post">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input id="loginName" type="text" name="username" size=”20” class="form-control" placeholder="请填写用户名" required >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input id="loginPassword" type="password" name="password" size=”21” class="form-control" placeholder="请填写密码" required >
                </div>
            </div>
            <div class="form-group">
    ...
    <br/> <br/>
    <h4> &nbsp; &nbsp; 没注册请先注册</h4>
    <a class="btn btn-info col-sm-2" data-toggle="modal"
            data-target="#myModal" type="button">注册</a>
</div>
